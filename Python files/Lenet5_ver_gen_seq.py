...
file.write('  reg signed [0:{}] Z_temp_c2d [0:{}];\n'.format((BITWIDTH_M2*DATAWIDTH_M2*DATAHEIGHT_M2-1),(FILTERBATCH_C1-1)))
...
file.write('  reg signed [0:{}] W_shift_c2d;\n'.format(BITWIDTH_W*KERNELWIDTH_C2*KERNELHEIGHT_C2-1))
...
file.write('  wire signed [{}:0] mem_x_ck_c2d [0:{}];\n'.format((BITWIDTH_M1-1),(KERNELWIDTH_C2*KERNELHEIGHT_C2-1)))
file.write('  wire signed [{}:0] mem_w_ck_c2d [0:{}];\n'.format((BITWIDTH_W-1),(KERNELWIDTH_C2*KERNELHEIGHT_C2-1)))
...
file.write('  //////////////////////////////// maxpool kernel /////////////////////////////////\n')
file.write('  \n')
file.write('  wire signed [{}:0]element_mk_m2[0:{}];\n'.format((BITWIDTH_C2-1),(KERNELWIDTH_POOL_M2*KERNELHEIGHT_POOL_M2-1)))
file.write('  reg signed [15:0] out_temp_mk_m2=0;\n')
file.write('  reg [{}:0] channel_select_m2;\n'.format(count_c2))
...
file.write('  reg [{}:0] neuron_select_d1;\n'.format(count_d1))
file.write('  reg [{}:0]count_d1=0;\n'.format(count_d1))
...
file.write('  reg signed [31:0] buffer_nc_d1_temp=0;\n')
...
file.write('  reg [15:0] din_buf_0,din_buf_1=0;\n')
...
file.write('  \n')
for i in range(FILTERBATCH_C1):
    for j in range(DATAWIDTH_M2*DATAHEIGHT_M2):        
...
file.write('  assign start_addr_conv_c2=channel_select_c2d*{}+window_select_c2+(window_select_c2/{})*{};\n'.format((DATAWIDTH_C2*DATAHEIGHT_C2),DATAWIDTH_M2,(DATAWIDTH_C2-DATAWIDTH_M2)))
file.write('  \n')
...
file.write('          endcase\n')
file.write('      end\n') 
file.write('      if(rst_d1==0)begin\n')
file.write('          if(count_d1<{})begin\n'.format(NEURONS_D1))
file.write('              addr_buf_d1=count_d1;\n') 
file.write("""              wr_en_buf_d1=1'b1;\n""")
file.write('          end\n')
file.write('          else begin\n')
file.write("""              addr_buf_d1={}'hX;\n""".format(ADDR_WIDTH_BUF_D1))
...
file.write('              result_temp_shift_c2d={{result_temp_shift_c2d[{}:{}],result_temp_ck_c2d}};'.format((BITWIDTH_M2),(BITWIDTH_M2*DATAWIDTH_M2*DATAHEIGHT_M2-1)))
file.write('          end\n')
file.write('          else\n')
...
file.write('          buffer_nc_d1_temp=buffer_nc_d1>>>4;\n')
file.write('          if(buffer_nc_d1_temp>32767 || buffer_nc_d1_temp<-32768)begin\n')
file.write('              if(buffer_nc_d1_temp>32767)\n')
file.write("""                  buffer_nc_d1_temp = 16'b0111111111111111;\n""")
file.write('              else\n')
file.write("""                  buffer_nc_d1_temp = 16'b1000000000000000;\n""")
file.write('          end\n')
file.write('          else begin\n')
file.write('              buffer_nc_d1_temp = buffer_nc_d1_temp[15:0];\n')
file.write('          end\n')
file.write('          result_temp_nc_d1=buffer_nc_d1_temp+bias_d1_1;\n')

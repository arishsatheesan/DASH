...
if(FILTERBATCH_C1*FILTERBATCH_C2*KERNELWIDTH_C2*KERNELHEIGHT_C2+FILTERBATCH_C2<2048):
    count_ld_shift_c2d=10
elif(FILTERBATCH_C1*FILTERBATCH_C2*KERNELWIDTH_C2*KERNELHEIGHT_C2+FILTERBATCH_C2<4096):
    count_ld_shift_c2d=11
elif(FILTERBATCH_C1*FILTERBATCH_C2*KERNELWIDTH_C2*KERNELHEIGHT_C2+FILTERBATCH_C2<8192):
    count_ld_shift_c2d=12
elif(FILTERBATCH_C1*FILTERBATCH_C2*KERNELWIDTH_C2*KERNELHEIGHT_C2+FILTERBATCH_C2<16384):
    count_ld_shift_c2d=13
elif(FILTERBATCH_C1*FILTERBATCH_C2*KERNELWIDTH_C2*KERNELHEIGHT_C2+FILTERBATCH_C2<32768):
    count_ld_shift_c2d=14

if(FILTERBATCH_C2*NEURONS_D1<1024):
    count_ld_nc_d1=9
elif(FILTERBATCH_C2*NEURONS_D1<2048):
    count_ld_nc_d1=10
elif(FILTERBATCH_C2*NEURONS_D1<4096):
    count_ld_nc_d1=11
elif(FILTERBATCH_C2*NEURONS_D1<8192):
    count_ld_nc_d1=12
elif(FILTERBATCH_C2*NEURONS_D1<16384):
    count_ld_nc_d1=13
elif(FILTERBATCH_C2*NEURONS_D1<32768):
    count_ld_nc_d1=14
...
file.write('  reg [{}:0]count_conv_c1=0;\n'.format(count_conv_c1))
...
file.write('  reg [{}:0] count_ld_shift_c2d=0;\n'.format(count_ld_shift_c2d))
for i in range(1,FILTERBATCH_C2+1):
...
file.write('  reg [{}:0]count_ck_c2d=0;\n'.format(count_ck_c2d))
...
file.write('///////////////////////////////////////// dense 1 ////////////////////////////////////////\n')
file.write('  reg [7:0] count_ld_d1=0;\n')
file.write('  reg done_load_d1;\n')
file.write('  reg [9:0] start_addr_d1;\n')
for i in range(1,FILTERBATCH_C2+1): 
    file.write('  reg signed [0:{}] X_nc_d1_ch{};\n'.format((BITWIDTH_M2-1),i))
...
file.write('  reg signed [0:{}] result_temp_nc_d1;\n'.format(BITWIDTH_D1-1))
file.write('  reg [2:0] state_d1=0;\n')
file.write('  wire signed [{}:0] bias_d1_shift [0:{}];\n'.format((BITWIDTH_B-1),(NEURONS_D1-1)))
file.write('////////////////////////////////////// neuron calculation 1/////////////////////////////////////\n')
file.write('  reg done_load_nc_d1=0;\n')
file.write('  reg [{}:0] count_ld_nc_d1=0;\n'.format(count_ld_nc_d1))
for i in range(1,FILTERBATCH_C2+1):
...
file.write('///////////////////////////////////////// dense 2 ////////////////////////////////////////\n')
file.write('  reg [4:0] count_ld_d2=0;\n')
file.write('  reg done_load_d2;\n')
file.write('  reg [9:0] start_addr_d2;\n')
file.write('  wire signed [{}:0] X_d2 [0:{}];\n'.format((BITWIDTH_D1-1),(NEURONS_D1-1)))
file.write('  reg signed [0:{}] X_nc_d2;\n'.format((BITWIDTH_D1-1)))
file.write('  reg [3:0] neuron_select_d2;\n')
file.write('  reg [4:0]count_d2=0;\n')
file.write('  reg done_nc_d2;\n')
file.write('  reg en_nc_d2;\n')
file.write('  reg rst_nc_d2;\n')
file.write('  reg signed [0:{}] result_temp_nc_d2;\n'.format(BITWIDTH_D2-1))
file.write('  reg [2:0] state_d2=0;\n')
file.write('  wire signed [{}:0] bias_d2_shift [0:{}];\n'.format((BITWIDTH_B-1),(NEURONS_D2-1)))
file.write('////////////////////////////////////// neuron calculation 2/////////////////////////////////////\n')
file.write('  reg done_load_nc_d2=0;\n')
file.write('  reg [10:0] count_ld_nc_d2=0;\n')
file.write('  reg signed [0:{}] w_neuron_nc_d2;\n'.format((BITWIDTH_W*NEURONS_D2-1)))
file.write('  reg signed [0:{}] bias_d2;\n'.format(BITWIDTH_B*NEURONS_D2-1))
file.write('  reg [4:0]count_nc_d2=0;\n')
file.write('  wire done_m_nc_d2;\n')
file.write('  reg en_m_nc_d2;\n')
file.write('  reg rst_m_nc_d2;\n')
file.write('  wire signed [{}:0] result_temp_m_nc_d2;\n'.format((BITWIDTH_D2-1)))  
file.write('  reg signed [0:{}] buffer_nc_d2=0;\n'.format((BITWIDTH_D2*NEURONS_D2-1)))
file.write('  wire signed [{}:0] mem_w_nc_d2 [0:{}];\n'.format((BITWIDTH_W-1),(NEURONS_D2-1)))
file.write('  reg signed [{}:0] w_in_m_nc_d2;\n'.format((BITWIDTH_W-1)))
file.write('  reg [2:0] state_nc_d2=0;\n')
file.write('  reg [4:0] weight_select_d2;\n')
for j in range(NEURONS_D2):
    file.write('  reg signed [0:{}] buf{}_d2=0;\n'.format((BITWIDTH_D2-1),j))
file.write('  \n')
for j in range(NEURONS_D1):        
    file.write('  reg signed [0:{}] p{}_d2;\n'.format((BITWIDTH_D2-1),j))
file.write('  \n')     
...
file.write('  \n')
for i in range(1,FILTERBATCH_C2+1):
    file.write('  reg [{}:0] result_temp_m_nc_d1_ch{}_temp;\n'.format((BITWIDTH_D1-1),i))
file.write('  \n')
file.write('  assign start_addr_conv_c1 = window_select_c1+(window_select_c1/{})*{};\n'.format(DATAWIDTH_M1,(DATAWIDTH_IN-DATAWIDTH_M1)))
file.write('  assign start_addr_conv_c2 = window_select_c2+(window_select_c2/{})*{};\n'.format(DATAWIDTH_M2,(DATAWIDTH_C2-DATAWIDTH_M2)))
...
file.write('               rst_c1=0;rst_m1=1;rst_c2=1;rst_m2=1;rst_d1=1;rst_d2=1;\n')
file.write('           end\n')
file.write('           2:begin\n')
...
file.write('           end\n')
file.write('           9:begin\n')
file.write('               en_c1=0;en_m1=1;en_c2=1;en_m2=0;en_d1=0;en_d2=0;en_sm=0;\n')
file.write('               rst_c1=0;rst_m1=0;rst_c2=0;rst_m2=1;rst_d1=1;rst_d2=1;\n')
file.write('           end\n')
file.write('           10:begin\n')
file.write('               en_c1=0;en_m1=1;en_c2=0;en_m2=0;en_d1=0;en_d2=0;en_sm=0;\n')
...
file.write('           end\n')
file.write('           11:begin\n')
file.write('               en_c1=1;en_m1=1;en_c2=1;en_m2=0;en_d1=0;en_d2=0;en_sm=0;\n')
file.write('               rst_c1=0;rst_m1=0;rst_c2=0;rst_m2=1;rst_d1=1;rst_d2=1;\n')
file.write('           end\n')
file.write('           12:begin\n')
file.write('               en_c1=1;en_m1=0;en_c2=1;en_m2=0;en_d1=0;en_d2=0;en_sm=0;\n')
file.write('               rst_c1=0;rst_m1=0;rst_c2=0;rst_m2=1;rst_d1=1;rst_d2=1;\n')
file.write('           end\n')
file.write('           13:begin\n')
file.write('               en_c1=0;en_m1=0;en_c2=1;en_m2=1;en_d1=0;en_d2=0;en_sm=0;\n')
file.write('               rst_c1=0;rst_m1=0;rst_c2=0;rst_m2=0;rst_d1=1;rst_d2=1;\n')
file.write('           end\n')
file.write('           14:begin\n')
file.write('               en_c1=0;en_m1=0;en_c2=1;en_m2=0;en_d1=0;en_d2=0;en_sm=0;\n')
...
file.write('           end\n')
file.write('           15:begin\n')
file.write('               en_c1=1;en_m1=0;en_c2=1;en_m2=1;en_d1=0;en_d2=0;en_sm=0;\n')
file.write('               rst_c1=0;rst_m1=0;rst_c2=0;rst_m2=0;rst_d1=1;rst_d2=1;\n')
file.write('           end\n')
file.write('           default:begin\n')
file.write('               en_c1=0;en_m1=0;en_c2=0;en_m2=0;en_d1=0;en_d2=0;en_sm=0;\n')
file.write('               rst_c1=1;rst_m1=1;rst_c2=1;rst_m2=1;rst_d1=0;rst_d2=1;\n')
file.write('           end\n')
file.write('      endcase\n')
...
file.write('              else if(count_shift_c1>n*{}-1) state=7;\n'.format(KERNELWIDTH_POOL_M1*DATAWIDTH_M1))
file.write('              else state=1;\n')
file.write('          end\n')
file.write('          2:begin\n')
file.write('              if(done_m1) state=3;\n')
file.write('              else if(count_shift_m1>=(m+{})*{}-1) state=9;\n'.format((KERNELWIDTH_C2-1),(DATAWIDTH_C2)))
file.write('              else state=2;\n')
file.write('          end\n')
file.write('          3:begin\n')
file.write('              if(done_c2) state=4;\n')
file.write('              else if(count_shift_c2d>(a+a+1)*{}-1) state=13;\n'.format(DATAWIDTH_M2))
...
file.write('          end\n')
file.write('          5:begin\n')
file.write('              if(done_den1) state=16; else state=5;\n')
file.write('          end\n')
file.write('          16:begin\n')
file.write('              if(done_den2) state=6; else state=16;\n')
file.write('          end\n')
file.write('          6:begin\n')
...
file.write('          8:begin\n')
file.write('              if(done_c1) state=2;\n')
file.write('              else if(count_shift_c1>n*{}-1) state=7;\n'.format(2*DATAWIDTH_M1))
file.write('              else if(count_shift_m1>=(m+{})*{}-1) state=12;\n'.format((KERNELWIDTH_C2-1),(DATAWIDTH_C2)))
...
for i in range(1,FILTERBATCH_C2+1):
    if(i==FILTERBATCH_C2):
        ...
        file.write('done_ck_c2d_row_ch{} && '.format(i))
file.write(') state=8;\n')
file.write('              else if(count_shift_c2d>(a+a+1)*{}-1) state=15;\n'.format(DATAWIDTH_M2))
...
file.write('          if(count_shift_c1<{})begin\n'.format(DATAWIDTH_M1*DATAHEIGHT_M1))
for i in range(1,FILTERBATCH_C1+1):
...
for i in range(1,FILTERBATCH_C1+1):
    file.write("""              oe_buf_1_c1_ch{}=1'b1;\n""".format(i))
for i in range(1,FILTERBATCH_C1+1):
    file.write('              addr_buf_1_c1_ch{} = start_addr_mk_m1+count_ld_mk_m1+{};\n'.format(i,i*(DATAWIDTH_M1-KERNELWIDTH_POOL_M1)))
file.write('              count_ld_mk_m1 = count_ld_mk_m1+1;\n')
file.write('              done_load_mk_m1=0;\n')
file.write('          end\n')
file.write('          else if(count_ld_mk_m1==4)begin\n')
...
for j in range(KERNELWIDTH_C2):
    if(j==0):
        file.write('          if(count_ld_conv_c2<{})begin\n'.format((j+1)*KERNELHEIGHT_C2))
        for i in range(1,FILTERBATCH_C1+1):
        ...
        for i in range(1,FILTERBATCH_C1+1):
            file.write("""              oe_buf_1_m1_ch{}=1'b1;\n""".format(i))
        for i in range(1,FILTERBATCH_C1+1):
            file.write('              addr_buf_1_m1_ch{} = start_addr_conv_c2+count_ld_conv_c2+{};\n'.format(i,(j*(DATAWIDTH_C2-KERNELHEIGHT_C2))))
        file.write('              count_ld_conv_c2 = count_ld_conv_c2+1;\n')
        file.write('              done_load_conv_c2=0;\n')
        file.write('          end\n')
...
for j in range(KERNELWIDTH_POOL_M2):
    if(j==0):
        file.write('          if(count_ld_mk_m2<{})begin\n'.format((j+1)*KERNELWIDTH_POOL_M2))
        for i in range(1,FILTERBATCH_C2+1):
        ...
        for i in range(1,FILTERBATCH_C2+1): 
            file.write("""              oe_buf_1_c2_ch{}=1'b1;\n""".format(i))
        for i in range(1,FILTERBATCH_C2+1): 
            file.write('              addr_buf_1_c2_ch{} = start_addr_mk_m2+count_ld_mk_m2+{};\n'.format(i,(j*(DATAWIDTH_M2-KERNELWIDTH_POOL_M2))))
        file.write('              count_ld_mk_m2 = count_ld_mk_m2+1;\n')
        file.write('              done_load_mk_m1=0;\n')
        file.write('          end\n')
...
for i in range(1,FILTERBATCH_C2+1):
    if(i==1):
        ...
        file.write('              addr_d1 = OFFSET_D1_W+(count_ld_nc_d1-{})*{}+{}+weight_select_d1;\n'.format(((i-1)*NEURONS_D1),(FILTERBATCH_C2*DATAWIDTH_D1*DATAHEIGHT_D1),((i-1)*DATAWIDTH_D1*DATAHEIGHT_D1)))
        file.write('              count_ld_nc_d1 = count_ld_nc_d1+1;\n')
        file.write('              done_load_nc_d1=0;\n')
        file.write('          end\n')
...
file.write('          else begin\n')
file.write("""              oe=1'b0;\n""")
file.write("""              count_ld_nc_d1=10'hX;\n""")
...
file.write('              addr_d1 = OFFSET_D2_B+count_ld_d2;\n')
...
file.write('              0:begin\n')
file.write('                  if(en_d2) state_d2=2; else state_d2=0;\n')
file.write('              end\n')
file.write('              1:begin\n')
...
file.write('              addr_d1 = OFFSET_D2_W+count_ld_nc_d2*{}+weight_select_d2;\n'.format((NEURONS_D1)))
...
file.write('          endcase\n')
file.write('      end\n')
file.write('          ///////////////////////////////end of dense 2 always block //////////////////////////////\n')
file.write('          ////////////////////////////////// soft max /////////////////////////////////\n')
...
for i in range(1,FILTERBATCH_C2+1):
    if(i==1):
        ...
        file.write('          w_neuron_nc_d1_ch{}={{w_neuron_nc_d1_ch{}[{}:{}], dout_d1}};\n'.format(i,i,(BITWIDTH_W),(BITWIDTH_W*NEURONS_D1-1)))
...
file.write('          bias_d2={{bias_d2[{}:{}], dout_d1}};\n'.format((BITWIDTH_B),(BITWIDTH_B*NEURONS_D2-1)))
file.write('  end\n')
file.write('  \n')
file.write('  always@(count_ld_nc_d2)begin\n')
file.write('      if(count_ld_nc_d2<{})\n'.format(NEURONS_D2+2))
file.write('          w_neuron_nc_d2={{w_neuron_nc_d2[{}:{}], dout_d1}};\n'.format((BITWIDTH_W),(BITWIDTH_W*NEURONS_D2-1)))
file.write('  end\n')
...
file.write('      end\n')
file.write('      else begin\n')
file.write('          if(count_shift_c1<{})begin\n'.format(DATAWIDTH_M1*DATAWIDTH_M1))
...
file.write('          end\n')
file.write('          else begin\n')
file.write("""              count_conv_c1={}'hx;\n""".format(count_conv_c1+1))
file.write('          end\n')
file.write('      end\n')
file.write('  end\n')
file.write('  \n')
...
file.write('          end\n')
file.write('          else begin\n')
file.write("""              count_ck_c2d={}'hX;\n""".format(count_ck_c2d+1))
file.write('          end\n')
file.write('      end\n')
file.write('  end\n')
file.write('  \n')
...
file.write('  \n')
if(DATAWIDTH_M2%2):
    file.write('  assign start_addr_mk_m2=window_select_m2*{}+(window_select_m2/{})*{};\n'.format((STRIDEWIDTH_POOL_M2),int(DATAWIDTH_M2/2),(DATAWIDTH_M2+1)))
else:
    file.write('  assign start_addr_mk_m2=window_select_m2*{}+(window_select_m2/{})*{};\n'.format((STRIDEWIDTH_POOL_M2),int(DATAWIDTH_M2/2),(DATAWIDTH_M2)))
file.write('  \n')
...
for i in range(NEURONS_D1):
    file.write('  assign bias_d1_shift[{}]=bias_d1[{}:{}];\n'.format(i,(i*BITWIDTH_B),((i+1)*BITWIDTH_B-1)))
file.write('  \n')
...
file.write('      if(count_d1=={})begin\n'.format(DATAWIDTH_D1*DATAHEIGHT_D1))
for i in range(NEURONS_D1):
    file.write('          fc_out_d1[{}:{}]='.format((i*BITWIDTH_D1),((i+1)*BITWIDTH_D1-1)))
    for j in range(1,FILTERBATCH_C2+1):
            file.write('buf{}_ch{} + '.format(i,j))
    file.write('(bias_d1_shift[{}]<<<6);\n'.format(i))
...
for i in range(1,FILTERBATCH_C2+1):
    file.write('              result_temp_m_nc_d1_ch{}_temp=result_temp_m_nc_d1_ch{}>>>4;\n'.format(i,i))
    file.write('              if(result_temp_m_nc_d1_ch{}_temp>32767 || result_temp_m_nc_d1_ch{}_temp<-32768)begin\n'.format(i,i))
    file.write('                  if(result_temp_m_nc_d1_ch{}_temp>32767)\n'.format(i))
    file.write("""                      result_temp_m_nc_d1_ch{}_temp = 16'b0111111111111111;\n""".format(i))
    file.write('                  else\n')
    file.write("""                      result_temp_m_nc_d1_ch{}_temp = 16'b1000000000000000;\n""".format(i))
    file.write('              end\n')
    file.write('              else begin\n')
    file.write('                  result_temp_m_nc_d1_ch{}_temp = result_temp_m_nc_d1_ch{}_temp[{}:0];\n'.format(i,i,(BITWIDTH_D1-1)))
    file.write('              end\n')
    file.write('              buffer_nc_d1_ch{} = {{buffer_nc_d1_ch{}[{}:{}],result_temp_m_nc_d1_ch{}}};\n'.format(i,i,(BITWIDTH_D1),(BITWIDTH_D1*NEURONS_D1-1),i))
file.write('          end\n')
file.write('      end\n')
file.write('  end\n')
file.write('  \n')
...
for i in range(1,FILTERBATCH_C2+1):
    for j in range(NEURONS_D1):
        file.write('          p{}_ch{}=buffer_nc_d1_ch{}[{}:{}];\n'.format(j,i,i,(j*BITWIDTH_D1),((j+1)*BITWIDTH_D1-1)))
    file.write('  \n')
...
#    file.write('  assign bias{}=bias_d1[{}:{}]<<6;\n'.format(i,(i*BITWIDTH_B),((i+1)*BITWIDTH_B-1)))
#file.write('  \n')
for i in range(NEURONS_D2):
    file.write('  assign bias_d2_shift[{}]=bias_d2[{}:{}];\n'.format(i,(i*BITWIDTH_B),((i+1)*BITWIDTH_B-1)))
file.write('  \n')

for i in range(NEURONS_D1):
    file.write('  assign X_d2[{}]=fc_out_d1[{}:{}];\n'.format((i),(i*BITWIDTH_D1),((i+1)*BITWIDTH_D1-1)))
file.write('  always@(posedge done_nc_d2 or posedge rst_d2)begin\n')
file.write('      if(rst_d2)begin\n')
file.write('          count_d2=0;\n')
for j in range(NEURONS_D2):
    file.write('          buf{}_d2=0;\n'.format(j))
file.write('      end\n')
file.write('      else begin\n')
file.write('          if(count_d2<{})begin\n'.format(NEURONS_D2))
file.write('              count_d2=count_d2+1;\n')
for j in range(NEURONS_D2):
    file.write('              buf{}_d2=buf{}_d2+p{}_d2;\n'.format(j,j,j))
file.write('          end\n')
file.write('          else begin\n')
file.write("""              count_d2=5'hX;\n""")
for j in range(NEURONS_D2):
    file.write('              buf{}_d2=buf{}_d2;\n'.format(j,j))
file.write('          end\n')
file.write('      end\n')
file.write('  end\n')
file.write('  \n')
...
file.write('              weight_select_d2=count_d2;\n')
file.write('          end\n')
file.write('          1:begin\n')
...
file.write('      if(count_d2=={})begin\n'.format(NEURONS_D2))
for i in range(NEURONS_D2):
    file.write('          fc_out_d2[{}:{}]=buf{}_d2 + (bias_d2_shift[{}]<<<6);\n'.format((i*BITWIDTH_D2),((i+1)*BITWIDTH_D2-1),i,i))
...
file.write('  \n')
for j in range(NEURONS_D2):
    file.write('  assign mem_w_nc_d2[{}]= w_neuron_nc_d2[{}:{}];\n'.format(j,(j*BITWIDTH_W),((j+1)*BITWIDTH_W-1)))
file.write('  \n')
...
file.write('              X_nc_d2=X_d2[count_nc_d2];\n')
file.write('          end\n')
file.write('          2:begin\n')
file.write('              en_m_nc_d2=0;\n')
file.write('              rst_m_nc_d2=1;\n')
...
file.write('      if (count_nc_d2=={})begin\n'.format(NEURONS_D2))
for j in range(NEURONS_D2):
    file.write('          p{}_d2=buffer_nc_d2[{}:{}];\n'.format(j,(j*BITWIDTH_D2),((j+1)*BITWIDTH_D2-1)))
file.write('  \n')
...
file.write('  end\n')
file.write('  \n')
file.write('  element_multiplier_d2#(BITWIDTH_D1,BITWIDTH_W,BITWIDTH_D2) element_mult_d2(\n')
file.write('  .clk(clk),\n')
file.write('  .in_ready(en_m_nc_d2),\n')
file.write('  .rst(rst_m_nc_d2),\n')
file.write('  .X_element(X_nc_d2),\n')
